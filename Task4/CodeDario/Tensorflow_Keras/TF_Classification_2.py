...
PrintOutput(y_test_pred, sample_number, os.path.join(StoreFolder, timestr + '_' + str(epochs) + '_' + str(param) + '_' + str(layers) + '_' + str(batch_size) + '_y_test.csv'))
...
plt.savefig(os.path.join(StoreFolder, timestr + '_' + str(epochs) + '_' + str(param) + '_' + str(layers) + '_' + str(batch_size) + '_TrainLoss.jpg'))
